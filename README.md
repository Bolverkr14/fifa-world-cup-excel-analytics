...
https://github.com/Bolverkr14/fifa-world-cup-excel-analytics/blob/main/images/dashboard-overview.png
...
- `documentation/data-dictionary.md` : dictionnaire des données ;
